        ...
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <h2 class="text-center hero-lead">Event Planner</h2>
                    <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to Event Planner <a
...
<div class="container-fluid custom-container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <hr>
            <h2 class="h2 text-uppercase text-center mb-4">Event Packages</h2>
        ...
        <div class="col-lg-6">
            <div class="feature">
                <ul class="list-group rounded-0">
                    <li class="list-group-item rounded-0 d-flex justify-content-between align-items-center ">Announce your Event
                    ...
                    <li class="list-group-item rounded-0 d-flex justify-content-between align-items-center">Plan your Event party
                        <span class="badge badge-pill" style="font-size: 12px;color:#888">Today <i class="mdi mdi-checkbox-blank-outline ml-3"></i></span>
                    </li>
                    <li class="list-group-item rounded-0 d-flex justify-content-between align-items-center">Schedule an photo shoot
                    ...
                    <li class="list-group-item rounded-0 d-flex justify-content-between align-items-center">Decide on your Event
                        <span class="badge badge-pill" style="font-size: 12px;color:#888">June 10 <i class="mdi mdi-checkbox-blank-outline ml-3"></i></span>
                    </li>
                    <li class="list-group-item rounded-0 d-flex justify-content-between align-items-center">Select your Event date
